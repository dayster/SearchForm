...
// Event Listen for Dom Loaded
document.addEventListener('DOMContentLoaded', () => {
    const cars = getCars();
    showCars(cars);
});

// Event Listener Form Elements
...
function showCars(cars){
    ...
    cars.forEach(car => {
        ...
        carHTML.innerHTML = `
            Make : ${car.make} - Model: ${car.carmodel} - Year:  ${car.year} -  Doors : ${car.doors}  - Price: ${car.price} - Transmission: ${car.transmission} - Color: ${car.color}
        `;
...
function noResult(){
    ...
    noResult.appendChild(document.createTextNode('No Result Found'));
